...
from . import api
from .api import bioportal_controller, nanopubs_controller, protocols_controller
...
def register(app: Flask, injector: Injector) -> Flask:
    ...
    """
    # api controllers
    injector.wire(modules=[api.bioportal_controller, api.nanopubs_controller, protocols_controller])
